...
export const ExpenseMenu =({expenseId}:{expenseId:Expense['id']})=> {
  ...
  //Editar gasto hay que mostrar el modal pasandole la ruta actual 
  // mas el parametro showModal=true que activa el modal desde la función de ModalContainer que evalua 
